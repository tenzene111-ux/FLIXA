...
import { createPlaylist, subscribePlaylists } from '../services/playlists';
import type { ProfileStackParamList } from '../navigation/ProfileStackNavigator';
import type { Playlist } from '../types/models';

type Props = NativeStackScreenProps<ProfileStackParamList, 'MyPlaylist'>;

export default function MyPlaylistScreen({ navigation }: Props) {
  ...
  useEffect(() => {
    if (!user) return;
    return subscribePlaylists(user.uid, setPlaylists);
  }, [user]);
